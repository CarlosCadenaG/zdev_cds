CLASS zcl_generate_travel_data_cac DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_cac IMPLEMENTATION.

 METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_cac.
...
*   delete existing entries in the database table
    ...
    DELETE FROM ztravel_cac.

*   insert the new table entries
    INSERT ztravel_cac FROM TABLE @itab.
